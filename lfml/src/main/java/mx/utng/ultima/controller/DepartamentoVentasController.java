...
import mx.utng.ultima.model.service.IDepartamentoVentasService;
...
public class DepartamentoVentasController {
    ...
    @Autowired
    private IDepartamentoVentasService departamentoService;
    ...
    public String create (Model model){
        ...
        model.addAttribute("departamento", new DepartamentoVentas());
        return "dform";
    }

    @GetMapping("/departamento/form/{id}")
    public String update(@PathVariable Long id,Model model){
        DepartamentoVentas departamento = null;
        if (id>0) {
    ...
    public String save(@Valid DepartamentoVentas departamento, BindingResult br, Model model){
